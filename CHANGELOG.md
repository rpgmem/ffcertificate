...
### Fixed
- Documentation tab — toggling a Quick-Navigation branch, or clicking the search field, no longer collapses the entire navigation card (the branch `<details>` and the search input are now excluded from the card's click-to-collapse). (#697)
