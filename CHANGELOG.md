...
- **`required` passa a acompanhar os blocos que o JS esconde** (#1117): campo obrigatório escondido trava o envio apontando para um controle que ninguém vê. Fecha junto um caso vivo desde a 4.1.0 — as linhas de horário de trabalho, obrigatórias dentro do bloco que o modo custom esconde.
