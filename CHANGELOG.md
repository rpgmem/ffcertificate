...
- **Public shortcode status branching rebalanced.**
  ...
  - `definitive` → renders the definitive list with a "Final classification." banner (user-facing copy preserved as it's a candidate-readable term). The two-section split (não-chamados / chamados) is unchanged.
