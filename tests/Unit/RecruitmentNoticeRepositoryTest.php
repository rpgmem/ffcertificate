...
use FreeFormCertificate\Recruitment\RecruitmentNoticeWriter;

/**
 * Tests for the notice repository read/write split — covers CRUD primitives
 * plus the atomic state-machine primitives used by the notice state machine
...
class RecruitmentNoticeRepositoryTest extends TestCase {
	...
	public function test_get_by_code_uppercases_input_before_lookup(): void {
		...
		RecruitmentNoticeReader::get_by_code( 'edital-2026-01' );
	...
	public function test_create_uppercases_code_and_uses_default_columns_config(): void {
		...
		$id = RecruitmentNoticeWriter::create( 'edital-2026-01', 'Edital de 2026' );
		...
		$this->assertSame(
			RecruitmentNoticeReader::DEFAULT_PUBLIC_COLUMNS_CONFIG,
	...
	public function test_set_status_returns_one_when_expected_current_matches(): void {
		...
		$affected = RecruitmentNoticeWriter::set_status( 5, 'preliminary', 'definitive' );
