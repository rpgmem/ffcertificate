...
class CptCapPolicyTest extends TestCase {
	...
	public function test_edit_post_on_cert_template_is_forced_to_manage_forms(): void {
		// #865 — the template pool shares the "Forms" management domain.
		Functions\when( 'get_post' )->justReturn( $this->fake_post( 'ffc_cert_template' ) );
