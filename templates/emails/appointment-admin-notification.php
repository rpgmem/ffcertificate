 ...
 *
 * Standalone (not wrapped by layout.php): admins get a compact table layout.
 * Rendered by AppointmentEmailHandler.
 *
...
<div style="font-family: sans-serif; max-width: 600px; margin: 0 auto;">
	<h3 style="color: #0073aa;"><?php echo esc_html__( 'New Appointment Booking', 'ffcertificate' ); ?></h3>
