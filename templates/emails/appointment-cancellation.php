 ...
 * and the pre-rendered {{cancellation_reason_block}} (empty when no reason was given).
 *
...
return array(
	...
	'body'    => '<h2 style="margin: 0 0 20px 0; font-size: 24px; color: #b3261e;">' . __( 'Appointment cancelled', 'ffcertificate' ) . '</h2>'
		...
		. '<p style="margin: 0 0 15px 0;">' . __( 'Your appointment has been cancelled.', 'ffcertificate' ) . '</p>'
