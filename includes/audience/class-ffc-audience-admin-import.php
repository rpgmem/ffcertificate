...
class AudienceAdminImport {
	...
	public function handle_csv_import(): void {
		...
		if ( isset( $_POST['ffc_action'] ) && 'import_members' === $_POST['ffc_action'] ) {
			...
			// phpcs:ignore WordPress.Security.ValidatedSanitizedInput.InputNotSanitized -- tmp_name is generated by PHP, not sent by the client, and is_uploaded_file() on the next line is what validates it.
