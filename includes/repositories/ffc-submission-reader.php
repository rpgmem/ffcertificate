 ...
 * Submission Reader
 *
 * Read-side of the submission repository split (#563 backlog, A6). Holds every
 * domain SELECT / lookup / aggregate / export-batch query. Writes live in
 * {@see SubmissionWriter}; {@see SubmissionRepository} remains the public façade
 * that delegates to both and still exposes the generic CRUD inherited from
 * {@see AbstractRepository}.
 *
 * Extends AbstractRepository so it reuses the same wpdb binding, table name,
 * cache group and helpers (findAll, get_cache, …) as before — the global $wpdb
 ...
 */
class SubmissionReader extends AbstractRepository {
