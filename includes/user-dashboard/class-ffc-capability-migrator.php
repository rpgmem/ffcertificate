 ...
 * CapabilityMigrator
 *
 * One-shot, option-flagged capability migrations — the 6.9.0 taxonomy renames
 * and the per-tier grant back-fills (delete / export / import / reasons).
 * Extracted from CapabilityManager (#563 Sprint 2): these run once per install
 * via the Loader on `plugins_loaded` and do not belong in the live capability
 * manager. (The pre-6.2.0 legacy certificate-cap rename was removed in 6.18.0,
 * #809 — long dormant on any install that passed through 6.2.0–6.17.0.)
 *
